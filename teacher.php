...
<a href="myarticle.php"><button class="b1" style="text-decoration: none;" id="articles" >My Articles</button></a>
<a href="myteachess.php"><button class="b1" style="text-decoration: none;" id="te" >My Teaching Essential</button></a>
<a href="article.php"><button class="b1" style="text-decoration: none;" id="cote" >Check articles</button></a>
<a href="teachess.php"><button class="b1" style="text-decoration: none;" id="cote" >Check teaching essential</button></a><br/>
</center>
